...
TensionGauge::TensionGauge()
{
	...
	m_tensionGaugeArrow.Init("Assets/modelData/tensionGaugeFrame.DDS", 500, 100);
	m_tensionGaugeArrow.SetPivot(Vector2(0.0f, 0.5f));
	m_tensionGaugeArrow.SetPosition(Vector3(500.0f, 0.0f, 0.0f));
	m_tensionGaugeArrow.SetScale(Vector3{ 1.0f, 1.0f, 1.0f });
